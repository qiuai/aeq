...
/**********************************************************add icon aside li *****************************************************************************/
    $(document).ready(function(){
       $('body').find('.box-category > ul > li > a').prepend('<i class="icon-caret-right"></i>');
       $('aside').find('.box-content .afine li > a').prepend('<i class="icon-caret-right"></i>');
       $('aside').find('.box-content .info li > a').prepend('<i class="icon-caret-right"></i>');
       $('aside').find('.box-content .info-list li > a').prepend('<i class="icon-caret-right"></i>');
       $('aside').find('.box-content .acount li > a').prepend('<i class="icon-caret-right"></i>');
       $('#content').find('.manufacturer-list ul>li>a').prepend('<i class="icon-caret-right"></i>');
       $('#content').find('.sitemap-info ul>li>a').prepend('<i class="icon-caret-right"></i>');
       $('#content').find('.content ul li>a').prepend('<i class="icon-caret-right"></i>');
       
    });
/******************************************************Aside box category**************************************************************************************/
$(document).ready(function(){
		jQuery('.box .box-category').find('li.parent').prepend('<i class="icon-caret-down"></i>');
		jQuery('.box .box-category li.parent i').on("click", function(){
		if (jQuery(this).hasClass('icon-caret-up')) { jQuery(this).removeClass('icon-caret-up').parent('li.parent').find('> ul').slideToggle(); } 
			else {
			jQuery(this).addClass('icon-caret-up').parent('li.parent').find('> ul').slideToggle();
			}
		});
