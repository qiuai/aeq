<div class="slideshow">
<!--  <div id="slideshow<?php echo $module; ?>" class="nivoSlider" style="max-width: 100%; width: <?php echo $width; ?>%px; height: <?php echo $height; ?>px;"> -->
  <div id="slideshow<?php echo $module; ?>" class="nivoSlider" style="max-width: 100%; min-height: 100px; width: <?php echo $width; ?>%px; height: <?php echo $height; ?>px;">
